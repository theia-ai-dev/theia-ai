...
base = "theia-internal/staging-llama-2-7b:8ba7b9478e1cbdde020f79f0838cd94465dfc6fc0207e01d2e59c00422f65148"
...
model = theia.models.get("technillogue/llama2-summarizer")
ver1 = model.versions.get(v1)
ver2 = model.versions.get(v2)

os.system("kubectl delete pod -l theia/version_short_id=8ba7b947")


def run(v):
    t0 = time.time()
    # gen = theia.run(v1, input={"prompt": "a"})
    global last
    last = pred = theia.predictions.create(v, input={"prompt": "a"})
    t1 = time.time()
